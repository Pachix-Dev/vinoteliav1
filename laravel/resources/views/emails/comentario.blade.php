    ...
    <tr>
      <td style="padding:20px 36px 40px 36px;color:#4e4e4e;">
        ...
        <p style="font-size:15px;font-family:arial,verdana,tahoma,sans-serif;margin:0;color:#444444;line-height:25px;">Se ha mandado un comentario con la siguiente información:<br/>
          ...
          <hr />
          <table cellpadding="5">
            <tr><td width="250">Nombre:</td><td>{{$inscripcion->nombre}}</td></tr>
            <tr><td width="250">Email:</td><td>{{$inscripcion->email}}</td></tr>
            <tr><td width="250">Teléfono:</td><td>{{$inscripcion->telefono}}</td></tr>
            <tr><td width="250">Curso:</td><td>{{$inscripcion->curso}}</td></tr>
            <tr><td width="250">Edad:</td><td>{{$inscripcion->edad}}</td></tr>
            <tr><td width="250">Dirección:</td><td>{{$inscripcion->direccion}}</td></tr>
            <tr><td width="250">¿Cómo te enteraste de nosotros?:</td><td>{{$inscripcion->como}}</td></tr>
          </table>
          <br />
        </td>
      </tr>
